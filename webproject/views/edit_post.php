...
<body class="bg-gray-100 min-h-screen flex items-center justify-center">
    <main class="container mx-auto p-6 max-w-md">
        <section class="bg-white rounded-lg shadow-md p-6">
            <h2 class="text-2xl font-bold text-gray-800 mb-6 text-center">ویرایش پست</h2>
                ...
                <form method="POST" action="" class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea name="content" id="content" rows="5" required
                                  class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-green-500"><?= htmlspecialchars($post['content']) ?></textarea>
                    </div>
                    <div>
                        <button type="submit"
